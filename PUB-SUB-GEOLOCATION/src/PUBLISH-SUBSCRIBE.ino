...
int rgb(const char* arg) {
  if (strcmp(arg, "red") == 0) { digitalWrite(R_LED, HIGH); }
  if (strcmp(arg, "green") == 0) { digitalWrite(G_LED, HIGH); }
  if (strcmp(arg, "blue") == 0) { digitalWrite(B_LED, HIGH); }
  if (strcmp(arg, "off") == 0) { digitalWrite(R_LED, LOW); digitalWrite(G_LED, LOW); digitalWrite(B_LED, LOW); }
  return 0;
}
